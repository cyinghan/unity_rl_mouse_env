...
env = UnityEnvironment(file_name='crawler_trainer')
...
print("Number of observations : ", len(group_spec.observation_shapes), group_spec.observation_shapes)
num_agents = 10
agent = PPO_Agent(env, 126, group_spec.action_size, num_agents)

model_dir = 'saved_models/'
model_name = 'unity_continuous_' + str(group_name) + '_' + str(num_agents) + '_maxscore6' + '_agents.pt'
