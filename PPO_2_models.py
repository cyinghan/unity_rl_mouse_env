...
class PPO_Actor(nn.Module):
    ...
    def __init__(self, image_size, proprio_size, action_size, device, seed=0):
        ...
        self.resnet = torch.hub.load('pytorch/vision:v0.6.0', 'resnet18', pretrained=False)
...
class PPO_ActorCritic(nn.Module):
    ...
    def __init__(self, image_size, proprio_size, action_size, device, seed=0):
        ...
        self.seed = torch.manual_seed(seed)
        self.actor = PPO_Actor(image_size, proprio_size, action_size, device, seed=seed)
        self.critic = PPO_Critic(image_size, proprio_size, action_size, device, seed=seed)
